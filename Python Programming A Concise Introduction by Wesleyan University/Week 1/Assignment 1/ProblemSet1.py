...
def problem1_4(miles):
    print("There are",(int)(5280*miles),"feet in",(int)(miles),"miles.") # replace this pass (a do-nothing) statement with your code
...
def problem1_6():
    for odd in range(1,100,1):
        if(odd%2==1):
            print(odd,end=" ")# replace this pass (a do-nothing) statement with your code
...
#%%
def problem1_7():
    b1 = input("Enter the length of one of the bases: ") # replace this pass (a do-nothing) statement with your code
    ...
    h = float(h)
    area = 0.5*(b1+b2)*h
    print("The area of a trapezoid with bases %.1f and %.1f"
    " and height %.1f is %.1f"%(b1,b2,h,area))          
